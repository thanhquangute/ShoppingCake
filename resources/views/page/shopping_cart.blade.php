							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									@if(Session::has('cart'))
										...
										<div class="media">
											<img width="25%" src="image/product/{{$value['item']['image']}}" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">{{$value['item']['name']}}</p>
												<span class="color-gray your-order-info">Đơn giá: {{($value['price']/$value['qty'])}}</span>
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">@if(Session::has('cart')){{number_format(Session('cart')->totalPrice)}} .đ @else 0 .đ @endif</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
