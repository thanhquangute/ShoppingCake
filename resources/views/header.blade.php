			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						@if(!Auth::check())
							<li><a href="{{route('trang-chu')}}"><i class="fa fa-user"></i>Tài khoản</a></li>
							<li><a href="{{route('dangky')}}">Đăng kí</a></li>
							<li><a href="{{route('dangnhap')}}">Đăng nhập</a></li>
						@else
							<li><a href="dang-xuat"><i class="fa fa-user"></i>{{Auth::user()->full_name}}</a></li>
						...
						@if(Session::has('cart'))
							<div class="cart">
								...
								<div class="beta-dropdown cart-body">
									...
									<div class="cart-item">
										<a class="cart-item-delete" href="del-item-cart/{{$product['item']['id']}}"><i class="fa fa-times"></i></a>
										<div class="media">
